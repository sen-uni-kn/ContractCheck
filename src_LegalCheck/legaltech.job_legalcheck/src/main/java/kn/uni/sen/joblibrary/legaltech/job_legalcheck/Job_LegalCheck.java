...
public class Job_LegalCheck extends JobAbstract implements ReportResult
{
	...
	private List<UmlAnalysisFactory> getAnalysisFactories(ResourceString resA, ResourceDouble resV)
	{
		...
		if (resA == null)
		{
			...
			resA.addNext(new ResourceString(UmlAnalysisSPAClaimLimit.Name));
		}
		while (resA != null)
		{
			...
			if (val.equals(UmlAnalysisSPAClaimLimit.Name))
				anaFacs.add(new UmlAnalysisSPAClaimLimit(this, val));
