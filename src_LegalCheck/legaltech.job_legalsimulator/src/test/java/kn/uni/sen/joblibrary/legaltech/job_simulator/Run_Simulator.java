package kn.uni.sen.joblibrary.legaltech.job_simulator;
...
public class Run_Simulator extends JobAbstractTest
{
	...
	{
		// ignoreTest = true;
		return new Job_LegalSimulator(this);
	}
